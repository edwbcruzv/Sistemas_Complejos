...
class Controllers(Frame):
    ...
    def __init__(self,master):
        ...
        self.VisualRastro=BooleanVar()
        self.OptionBorder=IntVar()
        self.SpeedSim=IntVar()
    ...
    def createWidgets(self):
        ...
        self.lbl_num_live=Label(self,text="Vida:0")
        ...
        self.lbl_num_generations=Label(self,text="Generacion:0")
        self.lbl_num_generations.grid(row=1,column=3,padx=value_padx,pady=value_pady,sticky=N+E+W)
        
        self.lbl_num_ants=Label(self,text="hormigas Vivas:0")
        self.lbl_num_ants.grid(row=1,column=3,padx=value_padx,pady=value_pady,sticky=S+E+W)
        ...
        self.cbtn_visual_rastro=Checkbutton(self,text="Rastros",variable=self.VisualRastro,onvalue=1
                                                   ,offvalue=0)
        self.cbtn_visual_rastro.grid(row=3,column=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.spn_box_speed=Spinbox(self,from_=100,to=10000,increment=100,textvariable=self.SpeedSim)
        ...
        self.btn_generate_distribution=Button(self,text="Generar Distribucion")
        self.btn_generate_distribution.grid(row=4,column=0,columnspan=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.scale_density=Scale(self,orient="horizontal",from_=0,to=100,
                        resolution=2)
        self.scale_density.grid(row=4,column=2,columnspan=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        # Fila 5
        self.btn_pause=Button(self,text="Pausar")
        self.btn_pause.grid(row=5,column=1,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.btn_clear=Button(self,text="Limpiar")
        self.btn_clear.grid(row=5,column=0,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.btn_run_simulation=Button(self,text="Correr/Reanudar simulacion")
        self.btn_run_simulation.grid(row=5,column=2,columnspan=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        # Fila 6
        self.lbl6=Label(self,text="Reinas:               ")
        self.lbl6.grid(row=6,column=0,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.spn_box_reinas=Spinbox(self,from_=1,to=90,)
        self.spn_box_reinas.config(width=4)
        self.spn_box_reinas.grid(row=6,column=0,padx=value_padx,pady=value_pady,sticky=E)
        
        self.lbl7=Label(self,text="Trabajadoras:              ")
        self.lbl7.grid(row=6,column=1,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.spn_box_trabajadoras=Spinbox(self,from_=1,to=90)
        self.spn_box_trabajadoras.config(width=4)
        self.spn_box_trabajadoras.grid(row=6,column=1,padx=value_padx,pady=value_pady,sticky=E)
        
        self.lbl8=Label(self,text="Reproductoras:         ")
        self.lbl8.grid(row=6,column=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.spn_box_reproductoras=Spinbox(self,from_=1,to=90)
        self.spn_box_reproductoras.config(width=4)
        self.spn_box_reproductoras.grid(row=6,column=2,padx=value_padx,pady=value_pady,sticky=E)
        
        self.lbl9=Label(self,text="Soldados:             ")
        self.lbl9.grid(row=6,column=3,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.spn_box_soldados=Spinbox(self,from_=1,to=90)
        self.spn_box_soldados.config(width=4)
        self.spn_box_soldados.grid(row=6,column=3,padx=value_padx,pady=value_pady,sticky=E)
        
        # Fila 7
        self.btn_reset_type_density=Button(self,text="Restablecer")
        self.btn_reset_type_density.grid(row=7,column=0,columnspan=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
        
        self.lbl10=Label(self,text="Parametros validos:")
        self.lbl10.grid(row=7,column=2,columnspan=2,padx=value_padx,pady=value_pady,sticky=S+N+E+W)
